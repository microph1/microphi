...
const loggator_1 = require("@microgamma/loggator");
const d = (0, loggator_1.getDebugger)('@flux/webpack/html-parser');
async function preprocessor(content, loaderContext) {
